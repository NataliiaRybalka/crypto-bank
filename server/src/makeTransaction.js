...
var _calculatePrice = _interopRequireDefault(require("../../lib/calculatePrice"));
...
async function handler(req, res) {
  try {
    ...
    const amount = (0, _calculatePrice.default)(req.query);
    ...
    const shopPublicKey = _addresses.shopAddress;
    ...
    const transferInstruction = _web.SystemProgram.transfer({
      fromPubkey: buyerPublicKey,
      lamports: amount.multipliedBy(_web.LAMPORTS_PER_SOL).toNumber(),
